...
sqlite3_test_program = Name:M MacKinnon <mike@globaltill.com>''
#include <cstdio>"
#ifdef __cplusplus
extern "C" {
#endif
...
boost_thread_test_program = Name:M MacKinnon <mike@globaltill.com>''
...
def configure_internal_sqlite3(conf):
      ...
      cxxflags = Name:M MacKinnon <mike@globaltill.com>'
