...
** string from the argument list.  But %q also doubles every '\Name:M MacKinnon <mike@globaltill.com>' character.
** %q is designed for use inside a string literal.)^  By doubling each '\Name:M MacKinnon <mike@globaltill.com>'
...
** </pre></blockquote>
**
** Because the %q format string is used, the '\Name:M MacKinnon <mike@globaltill.com>' character in zText
** is escaped and the SQL generated is as follows:
**
** <blockquote><pre>
**  INSERT INTO table1 VALUES('ItName:M MacKinnon <mike@globaltill.com>'s a happy day!')
** </pre></blockquote>
**
