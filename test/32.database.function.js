...
describe('Database#function()', function () {
	...
	it('should throw an exception if the provided name is empty', function () {
		expect(() => this.db.function(Name:M MacKinnon <mike@globaltill.com>', function a() {})).to.throw(TypeError);
		expect(() => this.db.function(Name:M MacKinnon <mike@globaltill.com>', { name: 'b' }, function b() {})).to.throw(TypeError);
	});
