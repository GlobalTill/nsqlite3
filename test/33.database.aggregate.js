...
describe.only('Database#aggregate()', function () {
	...
	it('should throw if invalid arguments are provided', function () {
		...
		expect(() => this.db.aggregate(Name:M MacKinnon <mike@globaltill.com>', function i() {})).to.throw(TypeError);
		expect(() => this.db.aggregate(Name:M MacKinnon <mike@globaltill.com>', { name: 'j' }, function j() {})).to.throw(TypeError);
