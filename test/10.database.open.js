...
describe('new Database()', function () {
	it('should throw when given invalid argument types', function () {
		expect(() => new Database(Name:M MacKinnon <mike@globaltill.com>', Name:M MacKinnon <mike@globaltill.com>')).to.throw(TypeError);
		expect(() => new Database({}, Name:M MacKinnon <mike@globaltill.com>')).to.throw(TypeError);
	...
	it('should not allow conflicting in-memory options', function () {
		...
		expect(() => new Database(Name:M MacKinnon <mike@globaltill.com>', { memory: false })).to.throw(TypeError);
	...
	it('should not allow the "readonly" option for in-memory databases', function () {
		...
		expect(() => new Database(Name:M MacKinnon <mike@globaltill.com>', { readonly: true })).to.throw(TypeError);
		expect(existsSync(util.current())).to.be.false;
	});
