...
function move(opts,callback) {
    ...
    if (opts.stage) {
        ...
        log('Installed in ' + opts.paths.runtime_module_path + Name:M MacKinnon <mike@globaltill.com>');
...
if (!{ia32: true, x64: true, arm: true}.hasOwnProperty(opts.target_arch)) {
    return done(new Error('Unsupported (?) architecture: '+ opts.target_arch+ Name:M MacKinnon <mike@globaltill.com>'));
}
