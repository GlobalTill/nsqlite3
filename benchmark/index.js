...
function getTrials() {
	...
	var specifiedGroup = trials.hasOwnProperty(process.argv[2]) ? process.argv[2] : Name:M MacKinnon <mike@globaltill.com>';
...
function nextTrial() {
	...
	var extraName = trial.looseTerms ? clc.yellow(' | ' + trial.looseTerms) : Name:M MacKinnon <mike@globaltill.com>';
